...
<link rel="apple-touch-icon" sizes="76x76"
	href="<spring:url value="/resources/screens/apple-icon.png" />">
<link rel="icon" type="image/png" sizes="96x96"
	href="<spring:url value="/resources/screens/favicon.png" />">

<title>Coming Sssoon Page by Creative Tim</title>

<!-- Canonical SEO -->
<link rel="canonical"
	href="http://www.creative-tim.com/product/coming-sssoon-page" />

<meta name="keywords"
	content="coming soon page, under construction page, bootstrap page, free bootstrap page, creative tim, not ready page, demo page">
